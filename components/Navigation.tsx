    ...
    <div className="flex items-center justify-between h-16">
      <div className="flex items-center">
        <div className="flex-shrink-0">
          <span className="text-2xl font-bold text-slate-900">PrimeHaven Realty</span>
        </div>
      </div>
      
      <div className="hidden md:block">
        <div className="ml-10 flex items-center space-x-8">
          <a href="#home" className="text-slate-900 hover:text-blue-600 px-3 py-2 text-sm font-medium transition-colors">
            Home
          </a>
          ...
          <a href="#contact" className="bg-slate-900 text-white hover:bg-slate-800 px-5 py-2 rounded-md text-sm font-medium transition-colors">
            Get Started
          </a>
        </div>
      </div>
