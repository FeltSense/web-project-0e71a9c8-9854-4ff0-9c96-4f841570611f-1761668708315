  ...
  <div className="max-w-7xl mx-auto">
    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="flex items-center gap-2">
        ...
        <span className="text-lg font-semibold">PrimeHaven Realty</span>
      </div>
      ...
      <nav className="flex flex-wrap items-center justify-center gap-8 text-sm">
        ...
        <a href="#agents" className="text-gray-300 hover:text-white transition-colors">Our Agents</a>
      ...
      <div className="flex items-center gap-6">
        ...
        <span className="text-gray-400 text-sm">© 2025 PrimeHaven Realty. All rights reserved.</span>
      </div>
    </div>
  </div>
</footer>
